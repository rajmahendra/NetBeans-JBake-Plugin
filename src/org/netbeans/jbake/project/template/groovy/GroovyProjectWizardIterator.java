 ...
 */
package org.netbeans.jbake.project.template.groovy;
...
public class GroovyProjectWizardIterator implements WizardDescriptor./*Progress*/InstantiatingIterator {
    ...
    public GroovyProjectWizardIterator() {
    }

    public static GroovyProjectWizardIterator createIterator() {
        return new GroovyProjectWizardIterator();
    }

    private WizardDescriptor.Panel[] createPanels() {
        return new WizardDescriptor.Panel[]{
            new GroovyProjectWizardPanel(),};
    }

    private String[] createSteps() {
        return new String[]{
            NbBundle.getMessage(GroovyProjectWizardIterator.class, "LBL_CreateProjectStep")
        };
    }
