...
public class TemplatesNode extends FilterNode {

    @StaticResource
    private static final String IMAGE = "org/netbeans/jbake/projecttype/jbake_logo.png";

    public TemplatesNode(Project proj) throws DataObjectNotFoundException {
        super(DataObject.find(proj.getProjectDirectory().getFileObject("templates")).getNodeDelegate());
    }
